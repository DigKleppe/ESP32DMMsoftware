...
#ifndef CONFIG_DEFAULT_FIRMWARE_UPGRADE_SERVER
	#define CONFIG_DEFAULT_FIRMWARE_UPGRADE_SERVER "none"
	#define CONFIG_DEFAULT_FIRMWARE_UPGRADE_URL "none"
	#define CONFIG_FIRMWARE_UPGRADE_FILENAME "none"
#endif
...
wifiSettings_t wifiSettingsDefaults = {
		...
		CONFIG_DEFAULT_FIRMWARE_UPGRADE_URL,CONFIG_FIRMWARE_UPGRADE_FILENAME,"999","999",false
};
